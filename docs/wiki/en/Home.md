# multiraft Wiki (English)

Welcome. This in-repo wiki mirrors what many projects put on GitHub Wiki, and stays versioned with the code.

**中文版：** [zh/Home.md](../zh/Home.md) · **README：** [../../README.md](../../../README.md)
